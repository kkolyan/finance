...
<%
    ...
    Item transfer = finances.getTransfer(transferId, userId);
    ...
    if (request.getMethod().equalsIgnoreCase("POST")) {
        if (action.equals("ModifyItem")) {
            ...
            if (atText != null) {
                ...
                finances.modifyTransfer(transferId, at, amount, name, parent, userId);
                ...
                finances.modifyTransfer(transferId, begin, end, amount, name, parent, userId);
            } else {
                finances.modifyGroup(transferId, name, parent, userId);
            }
        }
